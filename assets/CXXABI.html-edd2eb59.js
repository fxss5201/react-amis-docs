import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as c,c as d,a as s,b as n,d as e,e as r}from"./app-becab5ab.js";const o={},t={href:"https://github.com/TryGhost/node-sqlite3",target:"_blank",rel:"noopener noreferrer"},p=s("code",null,"/lib64/libstdc++.so.6: version CXXABI_1.3.8 not found",-1),u=r(`<h2 id="查看-libstdc-so-6-包含的-cxxabi-版本" tabindex="-1"><a class="header-anchor" href="#查看-libstdc-so-6-包含的-cxxabi-版本" aria-hidden="true">#</a> 查看 libstdc++.so.6 包含的 CXXABI 版本</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查看本地 CXXABI 所有可用版本</span>
